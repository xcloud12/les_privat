...
class M_Pengajuan extends Model
{
    ...
    public function allPengajuan()
    {
        ...
        $result = $les->select('id_pengajuan, kode, les.nama as les, user.nama as tentor, user.foto as tentor_foto, aktif, hari, jam_kerja, pengajuan_mengajar.deskripsi as deskripsi')
