        ...
        <div class="container text-white">
            <div class="row">
                ...
                <div class="col-sm-4 pt-5">
                    <p class="text-center">Masuk untuk hal menyenangkan </p>
        ...
        <div class="row justify-content-center mt-5 pt-5">
            <div class="col-5 ">
                <p data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consectetur, iure tempora earum cupiditate vel aspernatur quo debitis minus ipsum repellendus sequi pariatur, provident perspiciatis sed dolorem! Exercitationem reprehenderit eos nesciunt!
                </p>
                <hr class="pt-5 pb-5">
                <p data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consectetur, iure tempora earum cupiditate vel aspernatur quo debitis minus ipsum repellendus sequi pariatur, provident perspiciatis sed dolorem! Exercitationem reprehenderit eos nesciunt!
    ...
    <div>
        ...
        <footer id="sticky-footer" class="py-2 text-white shadow">
            <div class="container text-center">
                <small>Copyright &copy; Universitas Nurul Jadid </small>
            </div>
        </footer>
    </div>
