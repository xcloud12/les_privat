                            ...
                            <div class="row no-gutter justify-content-between">
                                ...
                                <div class="col-8">
                                    <div class="form-group row">
                                        ...
                                        <label for="nama" class="col-sm-8 col-form-label">: Budi Cahyono</label>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email" class="col-sm-4 col-form-label font-weight-bolder">Email</label>
                                        <label for="email" class="col-sm-8 col-form-label">: budiasoy@gmail.com</label>
                                    </div>
                                    <div class="form-group row">
                                        <label for="tempat_lahir" class="col-sm-4 col-form-label font-weight-bolder">Tempat lahir</label>
                                        <label for="tempat_lahir" class="col-sm-8 col-form-label">: Bondowoso</label>
                                    </div>
                                    <div class="form-group row">
                                        <label for="tanggal_lahir" class="col-sm-4 col-form-label font-weight-bolder">Tanggal lahir</label>
                                        <label for="tanggal_lahir" class="col-sm-8 col-form-label">: 16/06/1985</label>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label for="alamat" class="col-sm-8 col-form-label">: Jl pantura Bondowoso</label>
                                    </div>
                                    <div class="form-group row">
                                        <label for="no_telp" class="col-sm-4 col-form-label font-weight-bolder">No Telp</label>
                                        <label for="no_telp" class="col-sm-8 col-form-label">: 085234123612</label>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function disable(isdisable) {
        form_alamat.prop('disabled', isdisable);
    }
