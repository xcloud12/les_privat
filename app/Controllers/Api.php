...
class Api extends BaseController
{
    ...
    public function getLesByName($nama = '')
    {
        ...
        $data = $les->select('l.nama as mapel, l.biaya_daftar, l.harga, p.id_pengajuan, p.hari, p.jam_kerja, p.deskripsi as deskripsi_mengajar, t.nama as tentor, t.foto as foto ')
